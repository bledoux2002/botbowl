...
#    print(filename)
    ...
    while not found and generation <= generationLimit:
        ...
        for i in range (popSize):
            threads.append(threading.Thread(target=simGame, args=(chromoData, population, i, filename, generation, config, population_eval, ga, )))
        for i in range (popSize):
            threads[i].start()
        for i in range (popSize):
...
def simGame(chromoData, population, i, filename, generation, config, population_eval, ga):
